...
<p style="background-color: yellow; color: red"> IS A 32 BIT OPERATING SYSTEM FROM SCRATCH MADE BY Huguini79 TO SHOW PEOPLE HOW TO CREATE AN OPERATING SYSTEM FROM SCRATCH WITH A LOT OF DETAILS, LIKE A LOT OF COMMENTS IN C OR IN X86 ASSEMBLY</p>
